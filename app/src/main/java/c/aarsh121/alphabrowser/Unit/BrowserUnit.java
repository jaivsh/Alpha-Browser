package c.aarsh121.alphabrowser.Unit;
...
public class BrowserUnit {
    ...
    public static String queryWrapper(Context context, String query) {
        ...
        final int i;
            ...
            i = Integer.valueOf(Objects.requireNonNull(sp.getString(context.getString(R.string.sp_search_engine), "0")));
        switch (i) {
            case 0:
    ...
    public static void exportBookmarks(Context context) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            savedKey = Objects.requireNonNull(sp.getString("saved_key", "no"));
        }
    ...
    public static void clearCookie() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Toast.makeText(getContext(),"Your current Android version does not support this feature. Please Upgrade your android to use it.",Toast.LENGTH_LONG).show();
